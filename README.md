...
Welcome to **Shop** — an Angular-powered web application built with Angular CLI (v7.1.4).
...
Run e2e tests via [Protractor](http://www.protractortest.org/):
